...
def eval(epoch, args, test_areas = ['Area_5']):
    ...
    model = Res16FPN18_lvwConv_4_2_CSattn_2(in_channels=args.input_dim, out_channels=args.primitive_num, conv1_kernel_size=args.conv1_kernel_size, config=args).cuda()
    ...
    # print(args.semantic_class)
    all_labels_u = np.unique(all_labels)
    all_preds_u = np.unique(all_preds)
    # print("all_labels_u:",all_labels_u)
    # print("all_preds_u:",all_preds_u)
